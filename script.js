...
let bagpack = document.getElementById("bags");
...
function clicked() {
  console.log("amare tipon diche re");
}
...
let inputField = document.getElementById("exampleInputEmail1");
...
targetIMG.addEventListener("mouseenter", function (Event) {
  Event.target.src = "images/shoes/shoe-2.png";
});

targetIMG.addEventListener("mouseout", function (Event) {
